document.addEventListener('DOMContentLoaded', function() {
    ...
    // Lista de palavras para o tema países
    const wordThemes = {
    ...
    function startNewGame() {
        ...
        // Escolher tema (neste caso, sempre países)
        words = [...wordThemes.paises];
        
        // Atualizar indicador de tema
        document.querySelector('.game-level-indicator span').textContent = 'Tema: Países';
