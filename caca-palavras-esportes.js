document.addEventListener('DOMContentLoaded', function() {
    ...
    // Lista de palavras para o tema esportes
    const wordThemes = {
    ...
    function startNewGame() {
        ...
        // Escolher tema (neste caso, sempre esportes)
        words = [...wordThemes.esportes];
        
        // Atualizar indicador de tema
        document.querySelector('.game-level-indicator span').textContent = 'Tema: Esportes';
