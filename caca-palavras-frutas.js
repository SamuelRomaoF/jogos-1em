document.addEventListener('DOMContentLoaded', function() {
    ...
    // Lista de palavras para o tema frutas
    const wordThemes = {
    ...
    function startNewGame() {
        ...
        // Escolher tema (neste caso, sempre frutas)
        words = [...wordThemes.frutas];
        
        // Atualizar indicador de tema
        document.querySelector('.game-level-indicator span').textContent = 'Tema: Frutas';
